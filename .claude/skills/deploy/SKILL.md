...
CI then does the rest: it builds the image, pushes it to `ghcr.io/monkecloud/cubesnail.rip:<sha>`,
...
- A new PVC will be refused: this app is fully stateless.
